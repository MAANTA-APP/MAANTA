...
| Check (skill §) | Result |
|---|---|
| Focus-indicator contrast (§4.5) | **9 violations** → D173 |
| Placeholder-as-label (§4.6) | **8 rendered fields** → D174 |
...
### D173 — the amber focus ring (nine controls)
...
### D174 — eight fields whose only name was a placeholder

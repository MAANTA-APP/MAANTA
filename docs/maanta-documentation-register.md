...
| `docs/skills/scalability-retention-audit-2026-09-02.md` | founder, eng | eng | KEEP (new 2026-09-02) | the repo; `pg_stat_statements` | 2026-09-02 | **D234 or D235 closed**, the SW gains a `fetch` handler, or a shopper push sender ships | INTERNAL |

...
| `docs/skills/admin-founder-command-centre-2026-09-03.md` | eng, admin, founder | eng | KEEP | the pure rule modules and their tests | 2026-09-03 | Admin navigation, an Action Queue rule, the visit funnel, the founder verdict readings, or the `max_claims` vocabulary (D227) changes | INTERNAL |

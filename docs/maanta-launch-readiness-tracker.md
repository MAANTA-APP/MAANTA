...
| E10 | Production env vars set on Vercel + Supabase secrets audit | Engineer | 🟡 in progress | GATE | Repo audit + founder checklist 2026-07-28 (`docs/ops/backend-prod-setup-status-2026-07.md`); founder must confirm Vercel Production values + redeploy |

...
/**
 * Parity guard for drift **D72**: `src/lib/nodes.ts` and the `public.nodes`
 ...
 * shipped — the remaining half is tracked on D72 rather than implied here.
 *
...
describe("nodes.ts and the nodes table seed describe the same malls (D72)", () => {

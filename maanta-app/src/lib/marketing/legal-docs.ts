...
export const TOKEN_OWNERS: Record<string, string> = {
  ...
  SENTRY_BASIS_STATEMENT: "counsel",
  TRANSFER_BASIS: "counsel",
  LIABILITY_CAP: "counsel",
  REFUND_POLICY: "counsel",
  CREDIT_EXPIRY: "counsel",
  ENFORCEMENT_COMMITMENT: "product and counsel",
  DISPUTE_WINDOW: "product",
  DISPUTE_RESOLUTION_MECHANISM: "product",
  DISPUTE_LOSS_ALLOCATION: "product",
  ELITE_RENEWAL_TERMS: "product",
  FEE_CHANGE_NOTICE: "product",
  TERMS_CHANGE_NOTICE: "counsel",
  TAX_INCLUSIVE_OR_EXCLUSIVE: "counsel",
  PROHIBITED_CATEGORIES: "counsel",
  SHOPPER_RETENTION: "counsel",
  REDEMPTION_RETENTION: "counsel",
  ANALYTICS_RETENTION: "counsel",
  CONTACT_RETENTION: "counsel",
  AUTH_COOKIE_LIFETIME: "engineering",
  ANALYTICS_COOKIE_LIFETIME: "engineering",
  ANALYTICS_OPTOUT_INSTRUCTIONS: "product",
  ANALYTICS_CONSENT_STATEMENT: "product and counsel",
  COOKIE_CONSENT_STATEMENT: "product and counsel",
  CONTROLLER_RELATIONSHIP: "counsel",
};

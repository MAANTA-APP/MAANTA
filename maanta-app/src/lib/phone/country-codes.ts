/** ITU E.164 dial codes — vendored from open country metadata. */
export type CountryDialCode = { iso2: string; name: string; dialCode: string };
...
export const COUNTRY_DIAL_CODES: CountryDialCode[] = [
  ...
  { iso2: "BV", name: "Bouvet Island", dialCode: "+55" },
  ...
  { iso2: "HM", name: "Heard Island and McDonald Islands", dialCode: "+672" },
  { iso2: "HN", name: "Honduras", dialCode: "+504" },
  { iso2: "HK", name: "Hong Kong S.A.R.", dialCode: "+852" },
  ...
  { iso2: "MO", name: "Macau S.A.R.", dialCode: "+853" },
  ...
  { iso2: "IM", name: "Man (Isle of)", dialCode: "+44" },
  ...
  { iso2: "PS", name: "Palestinian Territory Occupied", dialCode: "+970" },
  ...
  { iso2: "PN", name: "Pitcairn Island", dialCode: "+870" },
  ...
  { iso2: "MF", name: "Saint-Martin (French part)", dialCode: "+590" },
  ...
  { iso2: "SX", name: "Sint Maarten (Dutch part)", dialCode: "+1721" },
  ...
  { iso2: "GS", name: "South Georgia", dialCode: "+500" },
  ...
  { iso2: "SJ", name: "Svalbard and Jan Mayen Islands", dialCode: "+47" },
  ...
  { iso2: "BS", name: "The Bahamas", dialCode: "+1" },
  { iso2: "GM", name: "The Gambia", dialCode: "+220" },
  ...
  { iso2: "VG", name: "Virgin Islands (British)", dialCode: "+1" },
  { iso2: "VI", name: "Virgin Islands (US)", dialCode: "+1" },
  { iso2: "WF", name: "Wallis and Futuna Islands", dialCode: "+681" },
...
/** Kenya first for Node 0 default; then alphabetical by name. */
...
export function matchDialCode(e164: string): CountryDialCode | null {

  ...
  return (
    <main>
      <section className="bg-ink px-5 py-20 text-center">
        <h1 className="mx-auto max-w-2xl text-4xl font-black leading-tight text-white sm:text-5xl">
          The mall, made live.
        </h1>
      ...
      <section className="mx-auto max-w-4xl px-5 py-14">
        <div className="grid gap-6 sm:grid-cols-3">
          {[
            ...
            <div key={n} className="rounded-card border border-line bg-white p-5 text-center">

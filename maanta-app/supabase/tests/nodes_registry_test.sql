-- ============================================================
-- Test: nodes registry (20260802120000_nodes_registry.sql) — drift D60.
--
...
-- This is the constraint that did not exist before D60 — any typo was accepted.
DO $$
DECLARE
  v_mid UUID;
BEGIN
...
-- Scenario C: THE D60 CASE. Renaming a mall for display must not orphan
...
-- Scenario G: adding a mall is a row, which is the other half of D60.
DO $$
DECLARE
  v_mid   UUID;
  v_count INT;

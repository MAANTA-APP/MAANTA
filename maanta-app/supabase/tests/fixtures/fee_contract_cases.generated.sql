...
BEGIN
  ...
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
    VALUES (v_r_r1, v_m_m1,
            v_tx, 30, 'fixture reversal',
            v_uid, '2026-08-20T10:00:00Z');
...
--
-- deduct_success_fee_or_record_arrears can move a merchant's wallet against
-- a pending redemption when service_role supplies that reference. It is not
-- earned revenue, but it cannot disappear: the period must be unavailable
-- rather than report an available zero while money moved.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_fee-against-non-success-redemption-is-invalid_m1', 'fee.case.m1', '+254710000024',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_fee-against-non-success-redemption-is-invalid_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_fee-against-non-success-redemption-is-invalid_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  INSERT INTO public.merchant_transactions
    ...
    VALUES (v_m_m1, -70, 'success_fee', 'manual',
            '__fee_case_fee-against-non-success-redemption-is-invalid_2', 'fixture', v_r_rp, '2026-08-11T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('fee-against-non-success-redemption-is-invalid: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('fee-against-non-success-redemption-is-invalid: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('fee-against-non-success-redemption-is-invalid: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('fee-against-non-success-redemption-is-invalid: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('fee-against-non-success-redemption-is-invalid: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('fee-against-non-success-redemption-is-invalid: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: fee-against-non-success-redemption-is-invalid';
END $case$;
...
--
-- The same double-reversal shape with the borrowed timestamp closed off: the
-- second fee_reversal carries the SAME created_at as the first, so every
-- column corroboration compares — redemption, merchant, amount, approver,
-- snapshot and now the shared instant — matches the first row's audit. Only
-- the wallet_transaction_id link tells them apart, which is what this case
-- exists to keep pinned; without it the second row borrows the first's
-- approval and doubles the money returned.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_second-reversal-sharing-the-first-audit-timestamp_m1', 'fee.case.m1', '+254710000032',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_second-reversal-sharing-the-first-audit-timestamp_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_second-reversal-sharing-the-first-audit-timestamp_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, 30, 'fee_reversal', 'manual',
            '__fee_case_second-reversal-sharing-the-first-audit-timestamp_2', 'fixture', v_r_r1, '2026-08-15T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, 30, 'fee_reversal', 'manual',
            '__fee_case_second-reversal-sharing-the-first-audit-timestamp_3', 'fixture', v_r_r1, '2026-08-15T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('second-reversal-sharing-the-first-audit-timestamp: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('second-reversal-sharing-the-first-audit-timestamp: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('second-reversal-sharing-the-first-audit-timestamp: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('second-reversal-sharing-the-first-audit-timestamp: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('second-reversal-sharing-the-first-audit-timestamp: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('second-reversal-sharing-the-first-audit-timestamp: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: second-reversal-sharing-the-first-audit-timestamp';
END $case$;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-audit-row-disagrees-on-amount_m1', 'fee.case.m1', '+254710000033',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-audit-without-an-approver_m1', 'fee.case.m1', '+254710000034',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_fee-amount-disagrees-with-redemption-snapshot_m1', 'fee.case.m1', '+254710000035',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_redemption-linked-to-another-merchants-deal_m1', 'fee.case.m1', '+254710000036',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_redemption-linked-to-another-merchants-deal_m2', 'fee.case.m2', '+254710000037',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m2;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_gross-posted-before-verification_m1', 'fee.case.m1', '+254710000038',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_duplicate-gross-rows-for-one-redemption_m1', 'fee.case.m1', '+254710000039',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-posted-before-verification_m1', 'fee.case.m1', '+254710000040',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-without-an-original-fee_m1', 'fee.case.m1', '+254710000041',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_fee-row-with-no-redemption-parent_m1', 'fee.case.m1', '+254710000042',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
--
-- The unparented row and the unplaceable row in the same movement: no
-- redemption parent AND created_at = infinity. It cannot reach the
-- classified join — there is nothing to join through — so the only path that
-- can see it is the unparented count, and a window predicate requiring
-- isfinite() dropped it from that too. Both validation paths missed one row,
-- and the debited merchant's report answered an available zero. No window
-- owns an unplaceable timestamp, so every window must surface it.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_unparented-fee-with-an-unplaceable-timestamp_m1', 'fee.case.m1', '+254710000043',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_unparented-fee-with-an-unplaceable-timestamp_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_unparented-fee-with-an-unplaceable-timestamp_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_unparented-fee-with-an-unplaceable-timestamp_2', 'fixture', NULL, 'infinity',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('unparented-fee-with-an-unplaceable-timestamp: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('unparented-fee-with-an-unplaceable-timestamp: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('unparented-fee-with-an-unplaceable-timestamp: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('unparented-fee-with-an-unplaceable-timestamp: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('unparented-fee-with-an-unplaceable-timestamp: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('unparented-fee-with-an-unplaceable-timestamp: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: unparented-fee-with-an-unplaceable-timestamp';
END $case$;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_flagged-success-still-counts-and-its-reversal-reduces-net_m1', 'fee.case.m1', '+254710000044',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_flagged-success-counts-before-its-reversal-lands_m1', 'fee.case.m1', '+254710000045',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_unplaceable-fee-on-an-older-redemption-still-surfaces_m1', 'fee.case.m1', '+254710000046',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
--
-- The same shape at the other extreme. `-infinity` sorts BELOW every bound
-- where `infinity` sorts above, so a window predicate written as explicit
-- bounds has to name both — cover only the positive extreme and a fee row at
-- `-infinity` is dropped from the subject set and never flagged, which is
-- the identical available zero one sign over.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_negative-infinity-fee-on-an-older-redemption-surfaces_m1', 'fee.case.m1', '+254710000047',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_negative-infinity-fee-on-an-older-redemption-surfaces_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_negative-infinity-fee-on-an-older-redemption-surfaces_1', 'fixture', v_r_old, '-infinity',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('negative-infinity-fee-on-an-older-redemption-surfaces: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('negative-infinity-fee-on-an-older-redemption-surfaces: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('negative-infinity-fee-on-an-older-redemption-surfaces: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('negative-infinity-fee-on-an-older-redemption-surfaces: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('negative-infinity-fee-on-an-older-redemption-surfaces: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('negative-infinity-fee-on-an-older-redemption-surfaces: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: negative-infinity-fee-on-an-older-redemption-surfaces';
END $case$;

-- ---------------------------------------------------------------------------
-- unparented-fee-at-negative-infinity
--
-- The unparented unplaceable row at the other extreme: no redemption parent,
-- `created_at = -infinity`. It cannot reach the classified join and the
-- unparented count is the only path that can see it, so that count must name
-- both extremes too.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_unparented-fee-at-negative-infinity_m1', 'fee.case.m1', '+254710000048',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_unparented-fee-at-negative-infinity_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_unparented-fee-at-negative-infinity_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_unparented-fee-at-negative-infinity_2', 'fixture', NULL, '-infinity',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('unparented-fee-at-negative-infinity: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('unparented-fee-at-negative-infinity: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('unparented-fee-at-negative-infinity: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('unparented-fee-at-negative-infinity: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('unparented-fee-at-negative-infinity: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('unparented-fee-at-negative-infinity: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: unparented-fee-at-negative-infinity';
END $case$;
...
-- one parent over. Both diagnostics fire: the movement is invalid on the
-- deal mismatch, and because a malformed gross row cannot prove billing, the
-- redemption is also unbilled. That is the same pairing every
-- malformed-gross case shows, and it is now identical to what the global
-- report says about this chain.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_deal-owner-sees-corruption-on-its-own-deal_m1', 'fee.case.m1', '+254710000049',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_deal-owner-sees-corruption-on-its-own-deal_m2', 'fee.case.m2', '+254710000050',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m2;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
  ...
  ASSERT v_row.missing_fee_rows = 1,
    format('deal-owner-sees-corruption-on-its-own-deal: missing_fee_rows = %s, expected 1', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
...
--
-- The same one-sided blindness as the deal-owner corruption case, but with
-- NO fee movement at all — which is the shape the classified scope arm
-- cannot reach, because there is no movement to reach the redemption
-- through. A success naming m1 against m2's deal and never billed left m2
-- reading an available zero while m1 and the global report both reported the
-- missing fee. Completeness must be scoped the same way classification is.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_deal-owner-sees-a-missing-fee-on-its-own-deal_m1', 'fee.case.m1', '+254710000051',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_deal-owner-sees-a-missing-fee-on-its-own-deal_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;

  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_deal-owner-sees-a-missing-fee-on-its-own-deal_m2', 'fee.case.m2', '+254710000052',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m2;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m2, '__fee_case_deal-owner-sees-a-missing-fee-on-its-own-deal_m2', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m2;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('deal-owner-sees-a-missing-fee-on-its-own-deal: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('deal-owner-sees-a-missing-fee-on-its-own-deal: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('deal-owner-sees-a-missing-fee-on-its-own-deal: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('deal-owner-sees-a-missing-fee-on-its-own-deal: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 1,
    format('deal-owner-sees-a-missing-fee-on-its-own-deal: missing_fee_rows = %s, expected 1', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 0,
    format('deal-owner-sees-a-missing-fee-on-its-own-deal: invalid_rows = %s, expected 0', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m2;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: deal-owner-sees-a-missing-fee-on-its-own-deal';
END $case$;

-- ---------------------------------------------------------------------------
-- success-with-an-unplaceable-verification-time
--
-- A genuine unbilled success whose redeemed_at is `-infinity`. The candidate
-- set is windowed on the verification event, and `-infinity` fails `>=
-- since` while `infinity` fails `< until`, so a plain range dropped it from
-- EVERY window — and with no fee movement there is nothing for `touched` or
-- `classified` to reach it through. Measured before the fix: available 0
-- from both a bounded and an open-ended window, over a success nobody
-- billed. The movement side already treats an unplaceable timestamp as
-- belonging to no window; the verification side has to say the same thing.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_success-with-an-unplaceable-verification-time_m1', 'fee.case.m1', '+254710000053',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_success-with-an-unplaceable-verification-time_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;

  INSERT INTO public.redemptions
    (deal_id, merchant_id, user_id, otp_code, status, expires_at, redeemed_at, success_fee_charged, is_demo, fraud_flags, review_required)
    VALUES (v_d_m1, v_m_m1, v_uid, '100001', 'success',
            '-infinity'::timestamptz + INTERVAL '1 hour', '-infinity', 30,
            FALSE,
            NULL, FALSE)
    RETURNING id INTO v_r_r1;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('success-with-an-unplaceable-verification-time: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('success-with-an-unplaceable-verification-time: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('success-with-an-unplaceable-verification-time: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('success-with-an-unplaceable-verification-time: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 1,
    format('success-with-an-unplaceable-verification-time: missing_fee_rows = %s, expected 1', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('success-with-an-unplaceable-verification-time: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: success-with-an-unplaceable-verification-time';
END $case$;

-- ---------------------------------------------------------------------------
-- billed-success-with-an-unplaceable-verification-time
--
-- The same `-infinity` verification time, but WITH a valid fee. Placing it
-- in every window is not enough on its own: the ordering check passes,
-- because no finite timestamp is less than `-infinity`, so the gross row is
-- well-formed, `unbilled` is empty, and the report went back to available.
-- An unplaceable verification time is corruption in its own right and has to
-- be counted whether or not a fee exists — the two are separate questions
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_billed-success-with-an-unplaceable-verification-time_m1', 'fee.case.m1', '+254710000054',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_billed-success-with-an-unplaceable-verification-time_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_billed-success-with-an-unplaceable-verification-time_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('billed-success-with-an-unplaceable-verification-time: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('billed-success-with-an-unplaceable-verification-time: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('billed-success-with-an-unplaceable-verification-time: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('billed-success-with-an-unplaceable-verification-time: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('billed-success-with-an-unplaceable-verification-time: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('billed-success-with-an-unplaceable-verification-time: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: billed-success-with-an-unplaceable-verification-time';
END $case$;

-- ---------------------------------------------------------------------------
-- orphan-audit-pointing-at-another-merchants-transaction
--
-- An audit row for m1 whose wallet_transaction_id points at m2's top-up.
-- Neither `touched` nor `classified` looks at an excluded transaction type,
-- so nothing reaches that row through the movement paths, and the
-- orphan-audit count scoped only on the audit's own chain — leaving m2
-- reading an available zero over a malformed audit naming m2's own wallet
-- transaction. The next incomplete application of one parent, found by
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_orphan-audit-pointing-at-another-merchants-transaction_m1', 'fee.case.m1', '+254710000055',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_orphan-audit-pointing-at-another-merchants-transaction_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;

  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_orphan-audit-pointing-at-another-merchants-transaction_m2', 'fee.case.m2', '+254710000056',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m2;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m2, '__fee_case_orphan-audit-pointing-at-another-merchants-transaction_m2', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m2;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_orphan-audit-pointing-at-another-merchants-transaction_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;

  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m2, 500, 'topup', 'manual',
            '__fee_case_orphan-audit-pointing-at-another-merchants-transaction_2', 'fixture', v_r_r1, '2026-08-11T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
    VALUES (v_r_r1, v_m_m1,
            v_tx, 30, 'fixture orphan audit', v_uid,
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('orphan-audit-pointing-at-another-merchants-transaction: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('orphan-audit-pointing-at-another-merchants-transaction: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('orphan-audit-pointing-at-another-merchants-transaction: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('orphan-audit-pointing-at-another-merchants-transaction: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('orphan-audit-pointing-at-another-merchants-transaction: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('orphan-audit-pointing-at-another-merchants-transaction: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m2;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: orphan-audit-pointing-at-another-merchants-transaction';
END $case$;

-- ---------------------------------------------------------------------------
-- audit-and-reversal-timestamped-apart
--
-- A reversal whose audit row matches on every column the corroboration
-- checked — transaction, redemption, merchant, amount, approver — but
-- carries a different created_at. `reverse_success_fee` writes both rows in
-- one transaction and both columns default to now(), which is
-- transaction-start and therefore identical across the two inserts (read
-- from production: the RPC supplies neither timestamp). So a pair that
-- disagrees was assembled outside the atomic path, and until this rule it
-- could still subtract from net as a real reversal.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_audit-and-reversal-timestamped-apart_m1', 'fee.case.m1', '+254710000057',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_audit-and-reversal-timestamped-apart_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_audit-and-reversal-timestamped-apart_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, 30, 'fee_reversal', 'manual',
            '__fee_case_audit-and-reversal-timestamped-apart_2', 'fixture', v_r_r1, '2026-08-12T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
    VALUES (v_r_r1, v_m_m1,
            v_tx, 30, 'fixture reversal',
            v_uid, '2026-08-12T09:00:05Z');

  SELECT * INTO v_row FROM public.admin_fee_totals_for_merchants(
    '2026-08-01T00:00:00Z', '2026-09-01T00:00:00Z', ARRAY[v_m_m1]::uuid[]);

  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('audit-and-reversal-timestamped-apart: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('audit-and-reversal-timestamped-apart: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('audit-and-reversal-timestamped-apart: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('audit-and-reversal-timestamped-apart: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('audit-and-reversal-timestamped-apart: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 2,
    format('audit-and-reversal-timestamped-apart: invalid_rows = %s, expected 2', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: audit-and-reversal-timestamped-apart';
END $case$;
...
-- an independent foreign key, so an audit row can name m3 while the
-- movement, redemption and deal all name m1. Corroboration fails, so m1 and
-- global correctly read unavailable — but m3, whose name is on the approval,
-- read an available zero. Scope has to match every merchant a chain names,
-- and the audit row is one of them.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-audit-naming-a-third-merchant_m1', 'fee.case.m1', '+254710000058',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_reversal-audit-naming-a-third-merchant_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;

  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-audit-naming-a-third-merchant_m3', 'fee.case.m3', '+254710000059',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m3;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m3, '__fee_case_reversal-audit-naming-a-third-merchant_m3', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m3;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_reversal-audit-naming-a-third-merchant_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, 30, 'fee_reversal', 'manual',
            '__fee_case_reversal-audit-naming-a-third-merchant_2', 'fixture', v_r_r1, '2026-08-12T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
    VALUES (v_r_r1, v_m_m3,
            v_tx, 30, 'fixture reversal',
            v_uid, '2026-08-12T09:00:00Z');

  SELECT * INTO v_row FROM public.admin_fee_totals_for_merchants(
    '2026-08-01T00:00:00Z', '2026-09-01T00:00:00Z', ARRAY[v_m_m3]::uuid[]);

  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('reversal-audit-naming-a-third-merchant: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('reversal-audit-naming-a-third-merchant: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('reversal-audit-naming-a-third-merchant: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('reversal-audit-naming-a-third-merchant: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('reversal-audit-naming-a-third-merchant: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('reversal-audit-naming-a-third-merchant: invalid_rows = %s, expected 1', v_row.invalid_rows);

  DELETE FROM public.fee_reversals WHERE merchant_id = v_m_m1;
  DELETE FROM public.fee_reversals WHERE merchant_id = v_m_m3;
  DELETE FROM public.merchant_transactions WHERE merchant_id = v_m_m1;
  DELETE FROM public.redemptions WHERE merchant_id = v_m_m1;
  DELETE FROM public.deals WHERE merchant_id = v_m_m1;
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.merchant_transactions WHERE merchant_id = v_m_m3;
  DELETE FROM public.redemptions WHERE merchant_id = v_m_m3;
  DELETE FROM public.deals WHERE merchant_id = v_m_m3;
  DELETE FROM public.merchants WHERE id = v_m_m3;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: reversal-audit-naming-a-third-merchant';
END $case$;

-- ---------------------------------------------------------------------------
-- audit-row-pointing-at-a-non-reversal-movement
--
-- The audit table read in the other direction. Every rule here starts from a
-- movement and asks what corroborates it; nothing started from
-- `fee_reversals`, so a row whose wallet_transaction_id points at the GROSS
-- fee — every table constraint satisfied, no reversal movement anywhere —
-- was never examined, because there was no reversal movement to reach it
-- through. Measured before the fix: gross 30, net 30, available, with an
-- approved reversal on file. The table is UNIQUE(redemption_id), so that row
-- also blocks reverse_success_fee from ever doing the reversal properly: not
-- just a wrong figure, a stuck one.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_audit-row-pointing-at-a-non-reversal-movement_m1', 'fee.case.m1', '+254710000060',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_audit-row-pointing-at-a-non-reversal-movement_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_audit-row-pointing-at-a-non-reversal-movement_1', 'fixture', v_r_r1, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('audit-row-pointing-at-a-non-reversal-movement: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('audit-row-pointing-at-a-non-reversal-movement: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('audit-row-pointing-at-a-non-reversal-movement: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('audit-row-pointing-at-a-non-reversal-movement: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('audit-row-pointing-at-a-non-reversal-movement: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('audit-row-pointing-at-a-non-reversal-movement: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: audit-row-pointing-at-a-non-reversal-movement';
END $case$;

-- ---------------------------------------------------------------------------
-- audit-against-non-success-redemption-is-invalid
--
-- An approval record against a pending redemption cannot disappear merely
-- because successful-redemption classification never admits its parent. Even
-- when it points at an excluded transaction type, the audit direction must
-- make the period unavailable.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_audit-against-non-success-redemption-is-invalid_m1', 'fee.case.m1', '+254710000061',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_audit-against-non-success-redemption-is-invalid_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;

  INSERT INTO public.redemptions
    (deal_id, merchant_id, user_id, otp_code, status, expires_at, redeemed_at, success_fee_charged, is_demo, fraud_flags, review_required)
    VALUES (v_d_m1, v_m_m1, v_uid, '100001', 'pending',
            '2026-08-10T09:00:00Z'::timestamptz + INTERVAL '1 hour', '2026-08-10T09:00:00Z', 30,
            FALSE,
            NULL, FALSE)
    RETURNING id INTO v_r_rp;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, 30, 'topup', 'manual',
            '__fee_case_audit-against-non-success-redemption-is-invalid_1', 'fixture', v_r_rp, '2026-08-10T09:00:01Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
    VALUES (v_r_rp, v_m_m1,
            v_tx, 30, 'fixture orphan audit', v_uid,
            '2026-08-10T09:00:01Z');
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('audit-against-non-success-redemption-is-invalid: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('audit-against-non-success-redemption-is-invalid: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('audit-against-non-success-redemption-is-invalid: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('audit-against-non-success-redemption-is-invalid: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('audit-against-non-success-redemption-is-invalid: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('audit-against-non-success-redemption-is-invalid: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: audit-against-non-success-redemption-is-invalid';
END $case$;

-- ---------------------------------------------------------------------------
-- reversal-posted-before-its-own-charge
--
-- A reversal timestamped BEFORE the gross row it reverses.
-- `reverse_success_fee` reads the gross row before writing the credit, so a
-- genuine reversal always postdates its charge — but a bare sibling count
-- could not tell the two apart. With the redemption verified outside the
-- window, a window holding the reversal and not the later charge returned
-- gross 0, reversals 30, net -30, available: a NEGATIVE success-fee figure
-- presented as fact. Measured before the fix.
-- ---------------------------------------------------------------------------
DO $case$
DECLARE
  v_uid UUID;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_reversal-posted-before-its-own-charge_m1', 'fee.case.m1', '+254710000062',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
    VALUES (v_m_m1, '__fee_case_reversal-posted-before-its-own-charge_m1', 'x', NOW() + INTERVAL '30 days', FALSE)
    RETURNING id INTO v_d_m1;

  INSERT INTO public.redemptions
    (deal_id, merchant_id, user_id, otp_code, status, expires_at, redeemed_at, success_fee_charged, is_demo, fraud_flags, review_required)
    VALUES (v_d_m1, v_m_m1, v_uid, '100001', 'success',
            '2026-07-01T09:00:00Z'::timestamptz + INTERVAL '1 hour', '2026-07-01T09:00:00Z', 30,
            FALSE,
            NULL, FALSE)
    RETURNING id INTO v_r_r1;
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, 30, 'fee_reversal', 'manual',
            '__fee_case_reversal-posted-before-its-own-charge_1', 'fixture', v_r_r1, '2026-08-10T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  INSERT INTO public.fee_reversals
    (redemption_id, merchant_id, wallet_transaction_id, amount, note, approver_user_id, created_at)
  ...
  INSERT INTO public.merchant_transactions
    (merchant_id, amount, transaction_type, payment_provider, provider_reference, description, reference_id, created_at, is_demo)
    VALUES (v_m_m1, -30, 'success_fee', 'manual',
            '__fee_case_reversal-posted-before-its-own-charge_2', 'fixture', v_r_r1, '2026-09-10T09:00:00Z',
            FALSE)
    RETURNING id INTO v_tx;
  ...
  ASSERT v_row.available IS NOT DISTINCT FROM FALSE,
    format('reversal-posted-before-its-own-charge: available = %s, expected false', v_row.available);
  ASSERT v_row.gross_kes IS NOT DISTINCT FROM NULL,
    format('reversal-posted-before-its-own-charge: gross_kes = %s, expected NULL', v_row.gross_kes);
  ASSERT v_row.reversals_kes IS NOT DISTINCT FROM NULL,
    format('reversal-posted-before-its-own-charge: reversals_kes = %s, expected NULL', v_row.reversals_kes);
  ASSERT v_row.net_kes IS NOT DISTINCT FROM NULL,
    format('reversal-posted-before-its-own-charge: net_kes = %s, expected NULL', v_row.net_kes);
  ASSERT v_row.missing_fee_rows = 0,
    format('reversal-posted-before-its-own-charge: missing_fee_rows = %s, expected 0', v_row.missing_fee_rows);
  ASSERT v_row.invalid_rows = 1,
    format('reversal-posted-before-its-own-charge: invalid_rows = %s, expected 1', v_row.invalid_rows);
  ...
  DELETE FROM public.merchants WHERE id = v_m_m1;
  DELETE FROM public.users WHERE id = v_uid;
  RAISE NOTICE 'fee contract case passed: reversal-posted-before-its-own-charge';
END $case$;
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_cross-merchant-reference_m1', 'fee.case.m1', '+254710000063',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_cross-merchant-reference_m2', 'fee.case.m2', '+254710000064',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m2;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_cross-merchant-reference-from-debited-scope_m1', 'fee.case.m1', '+254710000065',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_cross-merchant-reference-from-debited-scope_m2', 'fee.case.m2', '+254710000066',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m2;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)
...
BEGIN
  ...
  INSERT INTO public.merchants
    (merchant_name, what3words_address, phone, node, status, is_visible, account_balance, is_demo)
    VALUES ('__fee_case_malformed-fee-outside-window-does-not-prove-completeness_m1', 'fee.case.m1', '+254710000067',
            'BBS Mall', 'active', TRUE, 1000, FALSE)
    RETURNING id INTO v_m_m1;
  INSERT INTO public.deals (merchant_id, title, image_url, expires_at, is_demo)

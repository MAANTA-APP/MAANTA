-- ============================================================================
-- Fee-reversal decision note made MANDATORY (Decisions Log 2026-07-23).
--
-- The frozen reversal policy (2026-07-22) captured the incident number and the
-- decision note as optional. Founder ruling 2026-07-23: every success-fee
-- reversal must carry a reviewer's rationale, so the decision note is now
-- REQUIRED end to end (UI disables confirm until a note is entered; the admin
-- route rejects an empty/whitespace note with 400; this RPC raises as the
-- database-level backstop). The incident number stays optional.
--
-- This migration ONLY adds the note guard. The fee math, the settle-arrears-
-- first credit, the one-reversal-per-redemption guard, the approver check, and
-- every other invariant are copied verbatim from
-- 20260722120000_admin_fee_reversal_wallet_credit.sql and are unchanged.
-- ============================================================================
